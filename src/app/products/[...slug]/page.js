      ...
      <div className="max-w-7xl mx-auto px-4 py-8">
        ...
        <div className="flex flex-col lg:flex-row gap-8">
          <div className="w-full lg:w-64 flex-shrink-0">
            {/* *** MAJOR FIX ***
                Adding the `key` prop here is crucial. It's derived from the URL's base filter.
                When the user navigates (e.g., from one category to another), the key changes,
                forcing React to create a new instance of FilterSidebar. This automatically
                resets the sidebar's internal state, preventing stale filters.
            */}
            <FilterSidebar 
